...
type Response_Row struct {
	...
	InheritsFromTreeNodeId    *dstore_values.IntegerValue   `protobuf:"bytes,30010,opt,name=inherits_from_tree_node_id,json=inheritsFromTreeNodeId" json:"inherits_from_tree_node_id,omitempty"`
	ValidTo                   *dstore_values.TimestampValue `protobuf:"bytes,30011,opt,name=valid_to,json=validTo" json:"valid_to,omitempty"`
	ValidFrom                 *dstore_values.TimestampValue `protobuf:"bytes,30015,opt,name=valid_from,json=validFrom" json:"valid_from,omitempty"`
	InheritsFromNodeId        *dstore_values.IntegerValue   `protobuf:"bytes,30017,opt,name=inherits_from_node_id,json=inheritsFromNodeId" json:"inherits_from_node_id,omitempty"`
	ValidFromChar             *dstore_values.StringValue    `protobuf:"bytes,30018,opt,name=valid_from_char,json=validFromChar" json:"valid_from_char,omitempty"`
}
...
func init() {
	proto.RegisterFile("dstore/engine/procedures/im_GetNodeProperties.proto", fileDescriptor0)
}

var fileDescriptor0 = []byte{
	// 1112 bytes of a gzipped FileDescriptorProto
	,
}
